...
namespace AspTemplate.API.Swagger;
...
internal sealed class SwaggerConfigureOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    {
        var descriptionFiles = Directory.EnumerateFiles(AppContext.BaseDirectory, "AspTemplate.*.xml").ToArray();
        ...
        options.AddServer(new OpenApiServer { Description = "App API", Url = pathBase });
